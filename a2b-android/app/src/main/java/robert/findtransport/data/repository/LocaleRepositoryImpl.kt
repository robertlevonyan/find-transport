...
class LocaleRepositoryImpl @Inject constructor(private val sharedPreferencesService: SharedPreferencesService) : LocaleRepository {

  override fun getCurrentLanguage(): String = sharedPreferencesService.getString(PREF_LANGUAGE, LNG_EN)?.takeIf { it.isNotEmpty() }
    ?: LNG_EN
