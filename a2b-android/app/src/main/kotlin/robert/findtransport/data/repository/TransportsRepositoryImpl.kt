...
//                    path("a2b/newtransport/")
        ...
        override suspend fun getBuses(): List<Transport> = transportsDao.getBuses()

        override suspend fun getMicrobuses(): List<Transport> = transportsDao.getMicrobuses()

        override suspend fun getTrolleybuses(): List<Transport> = transportsDao.getTrolleybuses()

        override suspend fun getMetro(): List<Transport> = transportsDao.getMetro()
        ...
        override suspend fun getTransportsForStop(id: Int): List<Transport> = transportsDao.getTransportsForStop(id)
